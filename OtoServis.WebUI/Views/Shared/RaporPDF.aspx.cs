...
namespace OtoServis.WebUI.Views.Shared
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    Repository<Haritaletisim> rpIletisim = new Repository<Haritaletisim>();
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/RaporDesign/RaporSonuc.rdlc");
